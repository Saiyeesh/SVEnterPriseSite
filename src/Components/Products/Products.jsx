...
import procut from "..//../assets/proSheets.jpg";
...
function Products() {
    return (
        <>
            <div className='proCutBack'>
                <h1>Non Woven Bag Sheets</h1>
            </div>
            <div className='profirstPart'>
                <div className='WImg'>
                    <img src={procut} alt='Wcut' className='procut'/>
                </div>
            ...
            <div className='prosecoundPart'>
                <h1>Non Woven Bags Manufacturing in India</h1>
                <img src={allbags} className='proallBags'/>
