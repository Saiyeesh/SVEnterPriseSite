...
import "./PLoopCutBag.css"

import pLoopcutimg from "..//../assets/ploop.jpg";
import LoopcutN from "..//../assets/ploop.jpg";
import { FaRegHandshake } from "react-icons/fa";

function PLoopCutBag() {
   return (
      <>
         <div className='pLoopcutBack'>
            <h1>Printed Loop Bags</h1>
         </div>
         <div className='pLoopcutfirstpart'>
            <div className='pLoopcutImgBox'>
               <img src={pLoopcutimg} className='pLoopcutImg' />
            </div>
         ...
         <div className='pLoopcutsecoundpart'>
            <h2>Non Woven Bags Manufacturer in India</h2>
            <img src={LoopcutN} alt='pLoopcutN' className='pLoopcutN' />
         ...
         <div className='pLoopcutthirdpart'>
         ...
         <div className='pLoopcutfourthpart'>
         ...
         <div className='pLoopcutfivthpart'>
